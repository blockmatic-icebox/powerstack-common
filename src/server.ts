...
export const start = async () => {
   ...
   * This distinction can make a difference if using powerstack-auth to only apply migrations/metadata,
  ...
  //   logger.info(
  //     `AUTH_SKIP_SERVE has been set to true, therefore powerstack-auth won't start`
  //   );
  // } else {
